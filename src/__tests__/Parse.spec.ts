...
type cases = [
  ...
  Expect<Equal<TParse<'(λy.y)'>, [Id, []]>>,
  Expect<Equal<TParse<'y (λy.y)'>, [App<Var<'y'>, Id>, []]>>,
  Expect<Equal<TParse<'(λy.y) (y)'>, [App<Id, Var<'y'>>, []]>>,
  Expect<Equal<TParse<'λy.y (y)'>, [App<Id, Var<'y'>>, []]>>,
  Expect<Equal<TParse<'(y) (λy.y)'>, [App<Var<'y'>, Id>, []]>>,
  Expect<Equal<TParse<'y (x y)'>, [App<Var<'y'>, XYApp>, []]>>,
  Expect<Equal<TParse<'(y) (x y)'>, [App<Var<'y'>, XYApp>, []]>>,
  Expect<Equal<TParse<'x y'>, [XYApp, []]>>,
  Expect<Equal<TParse<'x (y)'>, [XYApp, []]>>,
  Expect<Equal<TParse<'(x) y'>, [XYApp, []]>>,
  Expect<Equal<TParse<'λy.y x'>, [Abs<'y', App<Var<'y'>, Var<'x'>>>, []]>>,
